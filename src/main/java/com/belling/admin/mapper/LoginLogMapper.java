...
public interface LoginLogMapper extends BaseMapper<LoginLog, Integer> {
	 ...
	 * @return
	 */
	public int deleteByTime(@Param("startTime") String startTime);
	 ...
	 * @return
	 */
	public List<LoginLog> findPaginationByTime(@Param("userId") String userId,  @Param("startTime") String startTime, @Param("endTime") String endTime, Pagination<LoginLog> p);
