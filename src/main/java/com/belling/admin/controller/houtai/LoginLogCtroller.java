...
public class LoginLogCtroller extends BaseController {
	...
	@ResponseBody
	public TablePageResult page(HttpServletRequest req, String uId, String startTime, String endTime, Integer draw) {
		...
		page = loginLogService.findPaginationByTime(uId, startTime, endTime, page);
	...
	public @ResponseBody ResponseResult delete(String startTime) {
		loginLogService.deleteByTime(startTime);
