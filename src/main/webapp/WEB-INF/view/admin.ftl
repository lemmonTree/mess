	...
	<body>
		<div class="layui-layout layui-layout-admin" style="border-bottom: solid 5px #1aa094;">
			...
			<div class="layui-body" style="bottom: 0;border-left: solid 2px #1AA094;" id="admin-body">
				<div class="layui-tab admin-nav-card layui-tab-brief" lay-filter="admin-tab" style="height: 100%;">
					...
					<div class="layui-tab-content" style="height: 100%; padding: 5px 0 0 0;">
						<div class="layui-tab-item layui-show" style="height: 100%">
							<iframe src="${base}/welcome" style="height: 100%;"></iframe>
						</div>
					</div>
				</div>
			</div>
			...
			<script type="text/template" id="lock-temp">
				<div class="admin-header-lock" id="lock-box">
					...
					<div class="admin-header-lock-name" id="lockUserName">刘溜溜</div>
